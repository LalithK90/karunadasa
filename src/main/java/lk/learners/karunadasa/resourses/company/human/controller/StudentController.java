package lk.learners.karunadasa.resourses.company.human.controller;
...
import lk.learners.karunadasa.resourses.company.human.service.StudentService;
...
public class StudentController {
    ...
    public String patientAddFrom(Model model) {
        ...
        model.addAttribute("addStatus", Boolean.valueOf(true));
    ...
    @RequestMapping(value = {"/add", "/update"}, method = {org.springframework.web.bind.annotation.RequestMethod.POST})
    public String addPatient(@Valid @org.springframework.web.bind.annotation.ModelAttribute Student student, BindingResult result, Model model, RedirectAttributes redirectAttributes) {
        if (result.hasErrors()) {
        ...
        if (student.getId() != null) {
            ...
            if (student.getEmail() != null) {
                ...
                if (isFlag) {
                    ...
                    redirectAttributes.addFlashAttribute("alertStatus", Boolean.valueOf(true));
                    studentService.persist(student);
                    return "redirect:/student";
                }
                redirectAttributes.addFlashAttribute("message", "Successfully Update but Email was not sent.");
                redirectAttributes.addFlashAttribute("alertStatus", Boolean.valueOf(false));
                studentService.persist(student);
                return "redirect:/student";
            }
        ...
        student.setCreatedAt(dateTimeAgeService.getCurrentDate());
        student.setCreatedUser(userService.findByUserName(org.springframework.security.core.context.SecurityContextHolder.getContext().getAuthentication().getName()));
        studentService.persist(student);
        return "redirect:/student";
    }
