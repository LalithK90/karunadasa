package lk.learners.karunadasa.resoursesCompany.human.service;

import java.util.List;
import lk.learners.karunadasa.resoursesCompany.human.dao.StudentDao;
...
{
    private final lk.learners.karunadasa.resoursesCompany.human.dao.StudentDao StudentDao;
